        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('address')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('sqtf')
                    ->required()
                    ->numeric()
                    ->default(0),
                Forms\Components\TextInput::make('wife_speed')
                    ->required()
                    ->numeric()
                    ->default(0),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('sqtf')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('wife_speed')
                    ->numeric()
                    ->sortable(),
                ...
                // Menggunakan IconColumn untuk menampilkan ikon
                IconColumn::make('full_support_available')
                    ->boolean()
                ...
                IconColumn::make('gym_area_available')
                    ->boolean()
                    ->trueIcon('heroicon-m-check')
                    ->falseIcon('heroicon-m-x-mark')
                    ->trueColor('success')
                ...
                IconColumn::make('mini_cafe_available')
                    ->boolean()
                    ->trueIcon('heroicon-m-check')
                    ->falseIcon('heroicon-m-x-mark')
                    ->trueColor('success')
                ...
                IconColumn::make('cinema_available')
                    ->boolean()
                    ->trueIcon('heroicon-m-check')
                    ->falseIcon('heroicon-m-x-mark')
                    ->trueColor('success')
